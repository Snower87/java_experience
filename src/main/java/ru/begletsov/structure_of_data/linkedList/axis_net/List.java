 ...
 * Список содержит в себе указатель на первый элемент списка и на последний - head и tail.
 * Также реализует методы:
...
class List {
    ...
    void deleteElement(int data)          //удаление элемента
    {
        if(head == null)        //если список пуст -
