 ...
 * @Описание Использовать метод boxed интерфейса Stream для обертывания элементов. Мож-но вместо этого отобразить значения, пользуясь подходящим классом-оберт-кой, или воспользоваться вариантом метода collect с тремя аргументами.
