...
import static ru.begletsov.job4j_tasks._142_stream._2_4_AveragingMethod.*;

public class _2_4_AveragingMethodTest {
    @Test
    public void test() {
        ...
        assertEquals(expect, _2_4_AveragingMethod.averaging(List.of(w1, w2, w3, w4, w5, w6)));
    }
}